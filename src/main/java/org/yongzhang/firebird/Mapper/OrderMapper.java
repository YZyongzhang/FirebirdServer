...
public interface OrderMapper {
    ...
    @Select("SELECT order_id AS orderId, total_amount AS totalAmount, status, date, user_id AS userId, " +
            ...
            "refund_status AS refundStatus, refund_time AS refundTime, refund_reason AS refundReason " +
    ...
    @Update("UPDATE orders SET status = 'delivered', receive_time = #{receiveTime} WHERE order_id = #{orderId}")
    ...
    @Select("SELECT o.order_id AS orderId, o.total_amount AS totalAmount, o.status, o.date, o.user_id AS userId, " +
            ...
            "o.refund_status AS refundStatus, o.refund_time AS refundTime, o.refund_reason AS refundReason " +
